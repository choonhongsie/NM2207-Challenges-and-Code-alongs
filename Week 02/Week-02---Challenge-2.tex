...
\textbf{Solution:} The term CSV stand for Comma-Separated Values. It is
a plain text file format that stores tabular data, where each row
represents a record and each column represents a field. The fields are
separated by commas.

There are several reasons that CSV files are a popular format storing
tabular data. Firstly, CSV files are easy to create and it is simple and
easy to understand. CSV format is human-readable and can be easily
created using any text editor. Secondly, CSV files can store a variety
of data types, including strings, integers, and dates. Compared to other
format like XML or JSON, CSV format do not need to care about tags.
Thirdly, CSV files are supported by many applications, including
spreadsheets, databases, and programming languages. This makes it easy
to import and export data from CSV files. Lastly, CSV files are a
relatively efficient way to store tabular data as they do not require
any special encoding or compression.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{"read\_csv.jpg"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\includegraphics[width=1\linewidth,height=1\textheight]{read_csv} \caption{read_csv Documentation}\label{fig:unnamed-chunk-5}
\end{figure}

\textbf{Question 1.6:} What does the \texttt{skip} argument in the
read\_csv() function do?

\textbf{Solution:} The `skip' argument in the read\_csv() function in R
specifies the number of rows to skip at the beginning of the file. This
can be useful if the file has a header row or other rows that I do not
want to include in the data frame.
...
\includegraphics{Week-02---Challenge-2_files/figure-latex/unnamed-chunk-14-1.pdf}
...
\includegraphics{Week-02---Challenge-2_files/figure-latex/unnamed-chunk-15-1.pdf}
...
\FunctionTok{ggplot}\NormalTok{(playlist\_data) }\SpecialCharTok{+}
\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Age,}\AttributeTok{y=}\NormalTok{Rating) }\SpecialCharTok{+}
\FunctionTok{labs}\NormalTok{(}\AttributeTok{x=}\StringTok{"Age"}\NormalTok{,}\AttributeTok{y=}\StringTok{"Rating."}\NormalTok{) }\SpecialCharTok{+}
\FunctionTok{geom\_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{Week-02---Challenge-2_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\FunctionTok{ggplot}\NormalTok{(playlist\_data) }\SpecialCharTok{+}
\FunctionTok{labs}\NormalTok{(}\AttributeTok{x=}\StringTok{"Age"}\NormalTok{,}\AttributeTok{y=}\StringTok{"Rating."}\NormalTok{) }\SpecialCharTok{+}
\FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Age,}\AttributeTok{y=}\NormalTok{Rating),}\AttributeTok{shape=}\DecValTok{2}\NormalTok{)}\CommentTok{\# \textless{}{-}{-} Hint: Use ? to learn more about geom\_point and use appropriate values for shape}
\end{Highlighting}
\end{Shaded}

\includegraphics{Week-02---Challenge-2_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\CommentTok{\# complete the code to generate the plot}
\FunctionTok{ggplot}\NormalTok{(playlist\_data) }\SpecialCharTok{+}
\FunctionTok{labs}\NormalTok{(}\AttributeTok{title=}\StringTok{"The Relationship Between Age and Rating of DJs"}\NormalTok{, }\AttributeTok{caption=}\StringTok{"There is no correlation between their age and rating."}\NormalTok{, }\AttributeTok{x=}\StringTok{"Age"}\NormalTok{,}\AttributeTok{y=}\StringTok{"Rating."}\NormalTok{) }\SpecialCharTok{+}
\FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Age,}\AttributeTok{y=}\NormalTok{Rating),}\AttributeTok{shape=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Week-02---Challenge-2_files/figure-latex/unnamed-chunk-18-1.pdf}
